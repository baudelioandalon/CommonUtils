...
import com.boreal.commonutils.databinding.CuFlowNavigationCellBinding

@Suppress("unused")
class FlowBottomNavigationCell @JvmOverloads constructor(
    context: Context,
    ...
    private val binding = DataBindingUtil.inflate<CuFlowNavigationCellBinding>(
        LayoutInflater.from(context),
        R.layout.cu_flow_navigation_cell,
        this,
        true
    )
